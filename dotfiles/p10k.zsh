# Generated by Powerlevel10k configuration wizard on 2019-09-02 at 00:42 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n%244F on %33F%m'

  # Context color when running with privileges.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=037
  # Context format when running with privileges: %n is username, %m is hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%n%244F on %33F%m'
